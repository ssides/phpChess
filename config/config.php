<?php
  ...
  $cookieName = 'sidesLocalChess_cookie';
  $thumbnailDim = 25;
  $positionDistance = 3;
  $pieceSize = 30;
  // the images folder must be called images and it must be in root.
  $uploadsDir = 'C:/src/phpChess/images/';
  $version = '1.1:15'; // displayed in the header. change in version forces the browser to get the latest styles.
